...
BeforeAll {
    ...
    function Get-ComputerInfoForTest
    {
        ...
        else
        {
            ...
            if ( $forceRefresh -or $null -eq $global:computerInfoAll)
            {
                $global:computerInfoAll = Get-ComputerInfo
            }
            return $global:computerInfoAll
        }
    }
...
AfterAll {
    Remove-Variable -Name computerInfoAll -Scope Global -ErrorAction SilentlyContinue
}
